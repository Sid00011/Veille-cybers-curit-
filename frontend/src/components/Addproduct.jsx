...
{/* </div> */} 
  ...
  <label className='block text-slate-300 mb-1 mt-3' htmlFor='email'>Category</label>
    {/* <MdOutlineMailOutline className="h-4 w-4 opacity-70" /> */}
  ...
  <label className='block text-slate-300 mt-3' htmlFor='email'>Upload Image</label>
<div className="input input-bordered flex items-center bg-transparent p-0 ">
    {/* <MdOutlineMailOutline className="h-4 w-4 opacity-70" /> */}
  <input type="File" className="bg-gray-700" min={0} placeholder='Upload image' required
